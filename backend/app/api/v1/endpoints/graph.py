...
def _get_demo_graph_data() -> GraphData:
    ...
    links = [
        ...
        GraphLink(id="10", source="10", source="15", relation="核心",   value=0.88, sentence="注意力机制是Transformer的核心"),
        GraphLink(id="11", source="11", source="3",  relation="属于",   value=0.85, sentence="监督学习属于机器学习"),
        GraphLink(id="12", source="12", source="3",  relation="属于",   value=0.84, sentence="无监督学习属于机器学习"),
        GraphLink(id="13", source="13", source="3",  relation="属于",   value=0.83, sentence="强化学习属于机器学习"),
        GraphLink(id="14", source="14", source="3",  relation="属于",   value=0.78, sentence="迁移学习属于机器学习"),
        # 技术实现
        GraphLink(id="15", source="15", source="10", relation="基于",   value=0.90, sentence="Transformer基于注意力机制"),
        GraphLink(id="16", source="16", source="15", relation="基于",   value=0.86, sentence="BERT基于Transformer架构"),
        GraphLink(id="17", source="17", source="15", relation="基于",   value=0.88, sentence="GPT基于Transformer架构"),
        GraphLink(id="18", source="18", source="8",  relation="属于",   value=0.82, sentence="CNN是深度学习的重要架构"),
        GraphLink(id="19", source="19", source="8",  relation="属于",   value=0.78, sentence="RNN是深度学习的重要架构"),
        GraphLink(id="20", source="19", source="10", relation="改进",   value=0.72, sentence="注意力机制改进了RNN的缺陷"),
        # 应用
        GraphLink(id="21", source="20", source="4",  relation="应用",   value=0.84, sentence="智能问答是NLP的典型应用"),
        GraphLink(id="22", source="20", source="17", relation="基于",   value=0.82, sentence="智能问答常基于GPT"),
        GraphLink(id="23", source="21", source="4",  relation="应用",   value=0.80, sentence="机器翻译是NLP的典型应用"),
        GraphLink(id="24", source="22", source="18", relation="基于",   value=0.78, sentence="图像识别基于CNN"),
        # 组织和学科
        GraphLink(id="25", source="28", source="7",  relation="关联",   value=0.65, sentence="DeepMind与辛顿的研究相关"),
        GraphLink(id="26", source="29", source="17", relation="开发",   value=0.84, sentence="OpenAI开发了GPT系列"),
        GraphLink(id="27", source="23", source="24", relation="依赖",   value=0.92, sentence="计算机科学依赖数学基础"),
        GraphLink(id="28", source="24", source="25", relation="支撑",   value=0.76, sentence="数学支撑语言学模型"),
        GraphLink(id="29", source="26", source="2",  relation="交叉",   value=0.74, sentence="认知科学与人工智能交叉研究"),
        GraphLink(id="30", source="3",  source="24", relation="依赖",   value=0.86, sentence="机器学习依赖数学"),
    ]
